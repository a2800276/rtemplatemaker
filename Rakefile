...
SHORTNAME	='rtemplatemaker'	# this should be the rubyforge project name
DESC		='templatemaker port to ruby'
PKG_VERSION 	='0.0.1'
LONG_DESC	= <<END_DESC
...
#task 'ext/templatemaker_ffi/extconf.rb' do
#  `pwd` 
#  `ruby #{Dir.pwd}/ext/templatemaker_ffi/extconf.rb`
#end


Rake::ExtensionTask.new("templatemaker_ffi")
